      ...
      <div id="portfolio" className="portfolio">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              <a
                href="https://amulet-horuscorp.vercel.app/"
                target="_blank"
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              ...
              <a
                href="https://github.com/HorusCorp/SunGym"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              <a
                href="https://portfolio-arnaud-rey.web.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
              ...
              <a
                href="https://github.com/HorusCorp/Portfolio"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              <a
                href="https://github.com/HorusCorp/PasswordGenerator"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              ...
              <a
                href="https://github.com/HorusCorp/YouTubeCloneWithReact"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
      ...
      <div id="portfolio" className="portfolio">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              <a
                href="https://genshin-35166.web.app"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
              ...
              <a
                href="https://github.com/HorusCorp/Characters-display"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              ...
              <a
                href="https://github.com/HorusCorp/Heaven"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              <a
                href="https://okami-video.web.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              ...
              <a
                href="https://github.com/HorusCorp/AssoGestionCotisation"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              <a
                href="https://github.com/HorusCorp/MyFridge"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
      ...
      <div id="portfolio" className="portfolio">
        ...
        <div className="project">
          ...
          <div className="project-txt">
            ...
            <div className="project-btn">
              <a
                href="https://hulu-clone-okami.web.app"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="btn-black">
